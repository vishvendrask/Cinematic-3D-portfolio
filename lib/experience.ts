...
export const SCENES: Scene[] = [
  {
    ...
    title: "Building Experiences That Feel Alive",
    description:
      "A futuristic desktop boots up. Seven years of building interfaces used by millions, distilled into one continuous scene.",
  ...
  },
  {
    ...
    title: "From Android Developer to Frontend Architect",
    description:
      "Open the folders to trace the path — early career, the Android years, the React evolution, architecture, and leading teams.",
  ...
  },
  {
    ...
    description:
      "IBM, Google, DBS Bank, Cencora and Globals — glowing connections between the places that defined the work.",
  ...
  },
  {
    ...
    title: "Platforms Floating in Depth",
    description:
      "The centerpiece. Project windows hover in space — hover any to expand its architecture, challenges and impact.",
  ...
  },
  {
    ...
    description:
      "Frontend, architecture, backend, testing, tooling and AI — rendered as live charts instead of static badges.",
  ...
  },
  {
    ...
    description:
      "10M+ users served, 30% faster, 50% fewer defects, teams led, awards won — the measurable dent.",
  ...
  },
  {
    ...
    description:
      "Agents, developer tools, human–computer interaction, intelligent interfaces and spatial computing — a living research lab.",
  ...
  },
  {
    ...
    description:
      "The lid slowly closes, the lights fade — but the conversation is just beginning. Bangalore, India.",
